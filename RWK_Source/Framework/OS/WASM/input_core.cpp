...
/**/
		if (SDL_NumJoysticks()==0)
		{
			...
			// Asking for help...
			// https://steamcommunity.com/groups/steamworks/discussions/22/3461605794233906585/
...
{
	if (Input_Core::gGameControllerList[theNumber]==NULL)
	{
...
void Input_Core::GetJoystickName(int theNumber, char *theName)
{
	...
	else 
	{
		...
		strcpy(theName,SDL_GameControllerName(gGameControllerList[theNumber]));
	}
